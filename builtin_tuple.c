...
BUILTIN_LISTLIKE_SLICE(TUPLE, ObjTuple, prealloc_tuple, new_tuple)
...
BUILTIN_LISTLIKE_MAP(TUPLE, ObjTuple, prealloc_tuple)
BUILTIN_LISTLIKE_FILTER(TUPLE, take_tuple)
BUILTIN_LISTLIKE_JOIN(TUPLE)
BUILTIN_LISTLIKE_REVERSE(TUPLE, ObjTuple, prealloc_tuple)
BUILTIN_LISTLIKE_EVERY(TUPLE)
BUILTIN_LISTLIKE_SOME(TUPLE)
BUILTIN_LISTLIKE_REDUCE(TUPLE)
BUILTIN_LISTLIKE_COUNT(TUPLE)
BUILTIN_LISTLIKE_CONCAT(TUPLE, ObjTuple, prealloc_tuple)
