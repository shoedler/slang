...
BUILTIN_DECLARE_METHOD(TYPENAME_OBJ, SP_METHOD_LEN)
...
BUILTIN_DECLARE_METHOD(TYPENAME_CLASS, SP_METHOD_GET)
...
BUILTIN_DECLARE_METHOD(TYPENAME_STRING, SP_METHOD_LEN)
...
BUILTIN_DECLARE_METHOD(TYPENAME_SEQ, SP_METHOD_LEN)
