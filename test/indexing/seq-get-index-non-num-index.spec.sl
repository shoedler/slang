...
print try a[almost_3] else error // [Expect] Type Seq does not support get-subscripting with Float.

// String
print try a["3"] else error      // [Expect] Type Seq does not support get-subscripting with Str.
