...
// Side effects
let b = (1,2,3)
print b.sift(fn (x) { b = (9, 9, 9) }) // [expect] ()
...
// Still makes a new tuple, even if the sift matches all elements. But since they are tuples, they are equal.
let d = (1,2,3)
print (d.sift(fn (x) -> true) == d) // [expect] true