...
BUILTIN_LISTLIKE_SLICE(SEQ, ObjSeq, prealloc_seq, new_seq)
...
BUILTIN_LISTLIKE_MAP(SEQ, ObjSeq, prealloc_seq)
BUILTIN_LISTLIKE_FILTER(SEQ, take_seq)
BUILTIN_LISTLIKE_JOIN(SEQ)
BUILTIN_LISTLIKE_REVERSE(SEQ, ObjSeq, prealloc_seq)
BUILTIN_LISTLIKE_EVERY(SEQ)
BUILTIN_LISTLIKE_SOME(SEQ)
BUILTIN_LISTLIKE_REDUCE(SEQ)
BUILTIN_LISTLIKE_COUNT(SEQ)
BUILTIN_LISTLIKE_CONCAT(SEQ, ObjSeq, prealloc_seq)
