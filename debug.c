...
int disassemble_instruction(Chunk* chunk, int offset) {
  ...
  switch (instruction) {
    ...
    case OP_MAP_LITERAL: return byte_instruction(STR(OP_MAP_LITERAL), chunk, offset);
    ...
    case OP_METHOD: return constant_instruction(STR(OP_METHOD), chunk, offset);
    ...
    case OP_IS: return constant_instruction(STR(OP_IS), chunk, offset);
